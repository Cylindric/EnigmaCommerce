<?php
	...
	while ($r = db_fetch_array($rsitemlist)) {
		...
		case(LIST_TYPE_COMPACT):
			if(($r['DetailCount']==0) || ($r['WebView']==0)) $html->assign("CLASS", 'unavailable');
			if($dbDeleted) $html->assign("CLASS", 'deleted');
			if($dbIsRecommended!=0) $html->parse("main.compact.row.recommended");
