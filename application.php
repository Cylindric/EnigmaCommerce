...
//set some shortcuts
if ($OPT->installedadmin)
    $OPT->adminroot = $OPT->enigmaroot . 'admin/';
if ($OPT->installedstore)
    $OPT->storeroot = $OPT->enigmaroot . 'frontend/';
...
//    echo "Host is " . $_SERVER['HTTP_HOST'] . ", expecting " . $OPT->httphost;
//      redirect_page();
//    exit;
}
